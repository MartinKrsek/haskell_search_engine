--code implemented from https://github.com/derekchiang/Haskell-Page-Rank/blob/master/pagerank.hs
--referenced in https://books.google.sk/books?id=ydo1DwAAQBAJ&pg=PA241&lpg=PA241&dq=pagerank+implementation+haskell&source=bl&ots=r-2N6ayUr-&sig=ACfU3U3FiPcihJFO8EworZAZGpIBJ3pvNA&hl=sk&sa=X&ved=2ahUKEwiKno6yuOv3AhUH36QKHV9BC58Q6AF6BAgCEAM#v=onepage&q=pagerank%20implementation%20haskell&f=false
...
processPagerank :: String -> Int -> Double -> PageRank
processPagerank input numIters dampingFactor =
